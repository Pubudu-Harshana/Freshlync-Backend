"""
Freshlync Demand Forecasting: Synthetic Data Generation Utility
=============================================================

This script generates synthetic order data containing products across different categories
(fish, meat, vegetable) with simulated quantities, prices, day of week, holidays, and weather conditions.
It saves the output to a CSV file to be used for model training and testing.
"""
...
def generate_synthetic_data(num_rows=2000, output_path='freshlync/ml_service/data/sample_orders.csv'):
    np.random.seed(42)
    random.seed(42)
